...
// This supports I/O operations that block only a goroutine, not a thread. 支持只阻塞g的io操作
// This is used by the net and os packages.  被net和os包使用
...
// consume removes data from a slice of byte slices, for writev call.
