...
The implementation compiles a custom codec编解码器 for each data type in the stream and
is most efficient最高效 when a single Encoder is used to transmit a stream of values,
