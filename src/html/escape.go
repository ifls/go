...
// EscapeString escapes special characters like "<" to become "&lt;". 转义, 将特殊字符转为几个正常字符组合表示
// It escapes only five such characters: <, >, &, ' and ".
// UnescapeString(EscapeString(s)) == s always holds, but the converse反向操作 isn't
// always true.
func EscapeString(s string) string {
	return htmlEscaper.Replace(s)
}

// UnescapeString unescapes entities like "&lt;" to become "<". 反转义
// It unescapes a larger range of entities than EscapeString escapes. For example, "&aacute;"
