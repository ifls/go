...
/*
Package multipart implements MIME(Multipurpose Internet Mail Extensions) multipart(复合文件) parsing, as defined in RFC
2046.
TODO https://developer.mozilla.org/zh-CN/docs/Web/HTTP/Basics_of_HTTP/MIME_types
The implementation is sufficient 够的 for HTTP (RFC 2388) and the multipart bodies generated by popular流行 browsers.
*/
package multipart
