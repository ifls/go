...
// The details vary变化 depending on the underlying system, and by default, godoc will display the syscall documentation for the current system.
...
// The primary use of syscall is inside other packages 其他包里that provide a more portable interface to the system, such as "os", "time" and "net".
// Use those packages rather than this one if you can.

// For details of the functions and data types in this package consult查询 the manuals for the appropriate operating system.
// These calls return err == nil to indicate success;
// otherwise err is an operating system error describing the failure. go-like error
// On most systems, that error has type syscall.Errno. syscall.Errno
//
// Deprecated: this package is locked down 封锁.
...
// See TODO https://golang.org/s/go1.4-syscall for more information.
//
package syscall
